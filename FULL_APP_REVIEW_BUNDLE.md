# Full App Review Bundle

Generated: 2026-04-02 Asia/Taipei

This bundle is intended for full-app review, including main UI logic, multi-trip logic, shared utilities, data, and PWA/runtime files.
...
Notes:
- Binary assets such as PNG/SVG icons are not embedded here.
- This bundle focuses on source code and runtime logic for review.
                                        ...
                                        <div v-if="renamingTripId !== trip.tripId && !isShareMode" class="relative flex items-center gap-2 justify-end">
                                            ...
                                            <details class="relative">
                                                ...
                                                <div class="trip-menu-panel absolute right-0 top-[calc(100%+0.55rem)] w-36 rounded-2xl p-2 z-10">
                                                    ...
                                                    <button type="button" @click="deleteTrip(trip)" class="w-full text-left px-3 py-2 rounded-xl text-xs font-bold text-s-alert hover:bg-black/5 transition-colors" :disabled="trip.tripId === activeTripId || trip.source === 'catalog'">
                                                        刪除
                                                    </button>
                                                </div>
                                            </details>
...
```json
{
  ...
  "description": "Seoul 2026 travel itinerary app with maps, notes, rates, and offline support.",
