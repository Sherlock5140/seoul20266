...
- SW cache: `travel-guide-v63-20260514-1655`
- Asset query version: `20260503h` for core app/config/service/catalog files; `20260514c` for Seoul trip data; `20260503d` for Hong Kong trip data; other shell assets keep existing query versions
