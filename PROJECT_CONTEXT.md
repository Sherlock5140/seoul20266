...
- SW cache: `travel-guide-v54-20260512-1418`
- Asset query version: `20260503h` for core app/config/service/catalog files; `20260512f` for Seoul trip data; `20260503d` for Hong Kong trip data; other shell assets keep existing query versions
