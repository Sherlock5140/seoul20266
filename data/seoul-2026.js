          ...
          },
          {
            ...
            events: [
              ...
              { id: "d6-e6", time: "13:30", location: "前往大型超市採買【A / B 二選一】", category: "shopping", note: "🕒 採買時間：約 1 - 1.5 小時（含找商品、比價、結帳與簡單整理）", coords: [37.5559, 126.9723], spots: [
                ...
                { name: "B. 龍山站 Emart 超市", type: "shopping", priority: "備選", note: "🚇 1號線 [鐘路3街] ➔ [龍山]\n🕒 移動：約 12-15 分鐘 + 步行\n🛒 採買：約 1 - 1.5 小時\n定位：回主團住宿區較順，採買後轉往弘大也相對直覺", coords: [37.5298, 126.9657] }
              ] },
              { id: "d6-e7", time: "15:00-15:30", location: "採買結束，前往弘大", category: "transport", note: "🚇 若選 A 首爾站樂天超市：AREX 一般列車 / 京義中央線 [首爾站] ➔ [弘大入口]\n🕒 約 10-15 分鐘 + 站內步行\n\n🚇 若選 B 龍山站 Emart：京義中央線 [龍山] ➔ [弘大入口]\n🕒 約 15-20 分鐘 + 步行", coords: [37.5563, 126.9236] },
              { id: "d6-e8", time: "15:30", location: "弘大商圈 / Nabi Hostel 周邊彈性時間", category: "shopping", note: "🕒 約 30 分鐘", coords: [37.5563, 126.9236] },
              { id: "d6-e9", time: "16:00", location: "晚餐：弘大匠人鐵板雞", category: "food", note: "🕒 預估停留：約 1 - 1.5 小時\n💡 定位：隊友離境前最後一餐，安排在弘大方便飯後回 Nabi Hostel 取行李\n⚠️ 風險：若 16:00 前未抵達弘大，建議直接前往餐廳，不再安排周邊逛街", coords: [37.5563, 126.9236] },
              { id: "d6-e10", time: "17:00", location: "隊友脫隊：返回 Nabi Hostel 領取行李", category: "hotel", note: "🚶 弘大區內步行返回住宿\n🕒 預估 17:30 前完成取行李", coords: [37.5563, 126.9236] },
              { id: "d6-e11", time: "17:40", location: "隊友前往弘大入口站", category: "transport", note: "🚶 Nabi Hostel ➔ 弘大入口站\n🕒 預估 5-10 分鐘", coords: [37.5572, 126.9245] },
              { id: "d6-e12", time: "18:00", location: "隊友搭乘 AREX 一般列車 ➔ 金浦機場站", category: "transport", note: "🚆 AREX 一般列車 [弘大入口] ➔ [金浦機場]\n🕒 車程約 14 分鐘\n💡 抵達金浦機場站後，仍需預留步行至航廈與報到時間", coords: [37.5621, 126.8019] },
              { id: "d6-e13", time: "18:30", location: "抵達金浦機場航廈，準備辦理 20:35 虎航 IT663 報到", category: "flight", note: "", coords: [37.5587, 126.8028] }
            ]
          },
          {
            date: "06/07 (日) Day 7",
