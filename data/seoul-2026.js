(function attachSEOUL2026TripData(global) {
  ...
  registerTravelGuideTrip("SEOUL_2026", {
        ...
        schedule: [
          ...
          {
            date: "06/06 (六) Day 6",
            title: "安國＋雞林食堂(3.5h)＋超市採買含移動(2h)＋弘大購物加晚餐(1.5–2h) 👥 白天 4人 ➔ 晚上主團 2人",
            ...
            events: [
              ...
              { id: "d6-e6", time: "13:00-13:30", location: "交通：雞林食堂 本店 ➔ 大型超市採買【A / B 二選一】", category: "transport", note: "", coords: [37.5559, 126.9723], spots: [
                { name: "A. 首爾站樂天超市", type: "shopping", priority: "首選", note: "🚇 1號線 [鐘路3街] ➔ [首爾站]\n🕒 移動：約 10-15 分鐘 + 站內步行", coords: [37.5545, 126.9707] },
                { name: "B. 龍山站 Emart 超市", type: "shopping", priority: "備選", note: "🚇 1號線 [鐘路3街] ➔ [龍山]\n🕒 移動：約 12-15 分鐘 + 步行", coords: [37.5298, 126.9657] }
              ] },
              { id: "d6-e7", time: "13:30-15:00", location: "大型超市採買【A / B 二選一】", category: "shopping", note: "🕒 採買時間：正常約 1 小時可結束，另預留 30 分鐘作為找商品、結帳與整理緩衝\n💡 若 14:30 前完成採買，可提早前往弘大；最晚建議 15:00 離開超市", coords: [37.5559, 126.9723], spots: [
                { name: "A. 首爾站樂天超市", type: "shopping", priority: "首選", note: "🛒 採買：正常約 1 小時，保守抓 1.5 小時\n定位：觀光客採買最方便，伴手禮、零食、泡麵、即食品品項完整\n風險：週六人潮多、結帳排隊時間較長；首爾站站內動線大，採買後前往 AREX 月台需預留步行時間", coords: [37.5545, 126.9707] },
                { name: "B. 龍山站 Emart 超市", type: "shopping", priority: "備選", note: "🛒 採買：正常約 1 小時，保守抓 1.5 小時\n風險：若採買後直接去弘大，需由龍山接京義中央線前往弘大入口", coords: [37.5298, 126.9657] }
              ] },
              { id: "d6-e8", time: "15:00-15:30", location: "採買結束，前往弘大", category: "transport", note: "🚇 若選 A 首爾站樂天超市：步行至 AREX / 京義中央線月台後，搭乘 [首爾站] ➔ [弘大入口]\n🕒 約 15-20 分鐘；若採買量大或站內人潮多，抓 20-25 分鐘\n\n🚇 若選 B 龍山站 Emart：京義中央線 [龍山] ➔ [弘大入口]\n🕒 約 15-20 分鐘 + 步行", coords: [37.5563, 126.9236] },
